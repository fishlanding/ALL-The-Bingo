...
tellraw @a[team=bingo_yellow] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_yellow]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_yellow]"}]
...
tellraw @a[team=bingo_red] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_red]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_red]"}]
...
tellraw @a[team=bingo_green] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_green]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_green]"}]
...
tellraw @a[team=bingo_orange] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_orange]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_orange]"}]
...
tellraw @a[team=bingo_gray] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_gray]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_gray]"}]
...
tellraw @a[team=bingo_pink] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_pink]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_pink]"}]
...
tellraw @a[team=bingo_blue] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_blue]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_blue]"}]
...
tellraw @a[team=bingo_aqua] [{"text": "已将 ","color": "green"},{"selector": "@a[tag=tp,team=bingo_aqua]"},{"text": "传送到 "},{"selector": "@a[tag=tpaccept,team=bingo_aqua]"}]
